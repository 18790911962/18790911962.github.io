...
// --- 动态生成照片列表（使用在线占位图，避免本地 /photos 缺失） ---
const TOTAL_NUMBERED_PHOTOS = 31;
const bodyPhotoPaths = [
  'https://picsum.photos/seed/top/512/512',
  ...Array.from({ length: TOTAL_NUMBERED_PHOTOS }, (_, i) => `https://picsum.photos/seed/${i + 1}/512/512`)
];
...
const Experience = ({ sceneState, rotationSpeed }: { sceneState: 'CHAOS' | 'FORMED', rotationSpeed: number }) => {
  ...
  return (
    <>
      ...
      <Sky distance={4500} sunPosition={[0.5, 1, 0.2]} turbidity={10} rayleigh={2} mieCoefficient={0.005} mieDirectionalG={0.8} />
